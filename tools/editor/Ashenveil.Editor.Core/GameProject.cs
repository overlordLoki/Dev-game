...
{
    /// <summary>
    /// Knows where things live inside a Ashenveil game folder. Every path the editor
    ...
    public class GameProject
    {
        ...
        public string ContentDir => Path.Combine(Root, "Ashenveil.Core", "Content");
        ...
        public string MapLoaderPath => Path.Combine(Root, "Ashenveil.Core", "Levels", "MapLoader.cs");
        public string TileMapPath   => Path.Combine(Root, "Ashenveil.Core", "Tiles", "TileMap.cs");
    }
}
