...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MonoGame.Framework.Devices.Sensors.Accelerometer+SensorListener, MonoGame.Framework", Accelerometer_SensorListener.class, __md_methods);
	}
	...
	public Accelerometer_SensorListener ()
	{
		...
		if (getClass () == Accelerometer_SensorListener.class) {
			mono.android.TypeManager.Activate ("MonoGame.Framework.Devices.Sensors.Accelerometer+SensorListener, MonoGame.Framework", "", this, new java.lang.Object[] {  });
		}
	}
