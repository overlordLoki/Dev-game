...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MonoGame.Framework.Devices.Sensors.Compass+SensorListener, MonoGame.Framework", Compass_SensorListener.class, __md_methods);
	}
	...
	public Compass_SensorListener ()
	{
		...
		if (getClass () == Compass_SensorListener.class) {
			mono.android.TypeManager.Activate ("MonoGame.Framework.Devices.Sensors.Compass+SensorListener, MonoGame.Framework", "", this, new java.lang.Object[] {  });
		}
	}
